...
Remove the `#` in front of `contentBar` in [line 81](https://github.com/vishalsingh17/SpotifyGithubIntegrator/blob/main/api/spotify.py#L81) of current master, then the EQ bar will be hidden when you're in not currently playing anything.

## Status String

Have a string saying either "Vibing to:" or "Last seen playing:".

* Change [`height` to `height + 40`](https://github.com/vishalsingh17/SpotifyGithubIntegrator/blob/main/api/templates/spotify.html.j2#L1-L2) (or whatever `margin-top` is set to)
* Uncomment [**.main**'s `margin-top`](https://github.com/vishalsingh17/SpotifyGithubIntegrator/blob/main/api/templates/spotify.html.j2#L10)
* Uncomment [currentStatus](https://github.com/vishalsingh17/SpotifyGithubIntegrator/blob/main/api/templates/spotify.html.j2#L93)
